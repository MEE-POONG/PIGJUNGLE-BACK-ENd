                ...
                <div className="d-flex align-items-center border-bottom py-2" >
                    <div className="table-responsive w-100">
                        ...
                        <Form.Group controlId="formFile" className="mb-3">
                            ...
                            <Form.Control type="text"style={{ width: "500px" }} value={contact.title} onChange={event => setTitle(event.target.value)} />
                        </Form.Group>

                        <Form.Group controlId="formFile" className="mb-3">
                            <Form.Label>ที่อยู่</Form.Label>
                            <Form.Control type="text"style={{ width: "800px" }} value={contact.address} onChange={event => setAddress(event.target.value)} />
                        </Form.Group>

                        <Form.Group controlId="formFile" className="mb-3">
                            <Form.Label>เบอร์โทรศัพท์</Form.Label>
                            <Form.Control type="text"style={{ width: "500px" }} value={contact.tel} onChange={event => setTel(event.target.value)} />
                        </Form.Group>

                        <Form.Group controlId="formFile" className="mb-3">
                            <Form.Label>อีเมล์</Form.Label>
                            <Form.Control type="text"style={{ width: "500px" }} value={contact.email} onChange={event => setEmail(event.target.value)} />
                        </Form.Group>

                        <Form.Group controlId="formFile" className="mb-3">
                            <Form.Label>เฟสบุค</Form.Label>
                            <Form.Control type="text"style={{ width: "500px" }} value={contact.facebook} onChange={event => setFacebook(event.target.value)} />
                        </Form.Group>

                        <Form.Group controlId="formFile" className="mb-3">
                            <Form.Label>ไลน์</Form.Label>
                            <Form.Control type="text"style={{ width: "500px" }} value={contact.line} onChange={event => setLine(event.target.value)} />
                        </Form.Group>

                        <Form.Group controlId="formFile" className="mb-3">
                            <Form.Label>ลิงค์แผนที่</Form.Label>
                            <Form.Control type="text" style={{ width: "500px" }} value={contact.linkmap} onChange={event => setLinkmap(event.target.value)} />
                        </Form.Group>
